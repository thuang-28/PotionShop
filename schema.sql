create table
  public.potion_index (
    sku text not null default 'COLOR'::text,
    price integer not null default 35,
    do_bottle boolean not null default true,
...
create table
  public.magic_numbers (
    id bigint generated by default as identity not null,
    per_barrel_budget integer not null,
    per_barrel_ml_limit integer not null,
    ml_cap_unit_limit integer not null default,
    pt_cap_unit_limit integer not null default,
    per_bottle_limit integer not null default,
    constraint magic_numbers_pkey primary key (id)
  ) tablespace pg_default;
